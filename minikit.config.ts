...
export const minikitConfig = {
  ...
  miniapp: {
    version: "1",
    name: "Tic-Tac-Toe", 
    subtitle: "Classic game with a crypto twist 🧠✨", 
    description: "Play Tic-Tac-Toe with smooth animations and smart logic. Built with ❤️ by GainChainn — fun, fast, and nostalgic!",
